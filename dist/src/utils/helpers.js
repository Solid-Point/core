...
exports.parseBundle = exports.formatBundle = exports.callWithLinearBackoff = exports.callWithExponentialBackoff = exports.generateName = exports.dataSizeOfBinary = exports.dataSizeOfString = exports.fromBytes = exports.toBytes = exports.sleep = exports.toHumanReadable = exports.toBN = void 0;
...
const generateName = (poolId, mnemonic, version) => {
    const r = new prando_1.default(`${poolId}${mnemonic}${version}`);
