...
class CLI extends commander_1.Command {
    constructor(runtime = process.env.KYVE_RUNTIME, packageVersion = process.env.KYVE_VERSION) {
        ...
        this.requiredOption("-s, --initial-stake <number>", "Your inital stake the node should start with. Flag is ignored node is already staked [unit = $KYVE].");
        ...
        this.option("-b, --batchSize <number>", "The batch size of fetching items from datasource. For synchronous fetching enter 1. [optional, default = 1]", "1");
