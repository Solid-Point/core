    ...
    async validateProposal(created_at) {
        ...
        while (true) {
            ...
            if (this.pool.bundle_proposal.bundle_id === "KYVE_EMPTY_BUNDLE") {
                ...
                console.log(cacheHeight, fromHeight, this.pool.min_bundle_size, fromHeight + parseInt(this.pool.min_bundle_size), cacheHeight < fromHeight + parseInt(this.pool.min_bundle_size));
